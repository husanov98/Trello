package uz.mh.trello.config.security;
...
import uz.mh.trello.config.security.jwt.JwtFilter;
...
public class SecurityConfigurer {
    ...
    public SecurityConfigurer(@Qualifier("accessTokenService") TokenService tokenService, AuthUserService authUserService, AuthEntryPoint authEntryPoint) {
